...
#        lista= list(id_prod,nombre,precio,stock,descripcion)
#        print(lista)
#        item = self.tabla.selection()
#        for i in item:
#            print("you clicked on", self.tabla.item(i, "values")[0])
    ...
    def eliminar_prod_carrito(self):
        ...
        '''item = self.tabla_carrito.item(self.tabla_carrito.selection())
        print(item)
        for v in item:
            self.tabla_carrito.delete(v)'''

        record =self.tabla_carrito.item(self.tabla_carrito.event_delete())
